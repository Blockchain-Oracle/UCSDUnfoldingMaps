...
public class EarthquakeCityMap extends PApplet {
	...
	//
	private CommonMarker selectMarkerIfHover(List<Marker> markers) {
		for (Marker marker : markers) {
			if (marker.isInside(map, mouseX, mouseY)) {
				if (!marker.isSelected()) {
					marker.setSelected(true);
					return (CommonMarker) marker; // Cast to CommonMarker
				}
			}
		}
		return null; // Return null if no marker is selected
	}
